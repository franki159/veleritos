...
function listar_parametros(p_control, tipo, p_async) {
    $.ajax({
        type: "POST",
...
function listar_inicio() {
    listar_parametros("sel_tip_comb", "TIP_COMBUS", false);
    listar_parametros("sel_color", "COL_EMB", false);
    listar_parametros("sel_ambito", "AMBITO", false);
    listar_parametros("sel_tipo_nav", "TIP_NAV", false);
    listar_parametros("sel_tipo_serv", "TIP_SERV", false);
    listar_parametros("sel_constructora", "CONSTRUCTORA", false);
    closeLoading();
}
