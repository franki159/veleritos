...
$("#btn_buscar").click(function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            var htmlBotones = '<button name="anular" title="Anular" class="btn btn-danger btn-xs"><i class="icon-trash"></i></button> ';
...
$("#btn_buscar_habitacion").click(function () {
    ...
    $.ajax({
        ...
        dataType: "json",
        data: JSON.stringify({
            objE: eHabitacion, idTipo: $("#sel_tipo").val()
        }),
        async: true,
        beforeSend: function () {
